class Employee	
{
    ...
    double grossSAl;
	String empName;
    Employee(String name,int no,int sal,int da,int hra)
    {
        empName = name;
        empNo = no;
        basicSal = sal;
...
class empDriver
{
	...
	{
		Employee emp1=new Employee("Ram",1,50000,10000,5000);
	    Employee emp2=new Employee("Jkhunme",2,30000,30000,4000);	
